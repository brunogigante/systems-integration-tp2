...
function PortugueseCitiesStores() {
    ...
    useEffect(() => {
        const getStores = async () => {
            const data = await fetch('http://localhost:20004/api/portuguese_cities_stores')
    ...
    return (
        <>
            <h1>NumberStoresOwnership</h1>
            <TableContainer component={Paper}>
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell>City name</TableCell>
                            <TableCell align="center">Number of stores</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {
...
export default PortugueseCitiesStores;
