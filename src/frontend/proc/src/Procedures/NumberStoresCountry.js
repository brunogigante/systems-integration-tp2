...
function NumberStoresCountry() {
    ...
    useEffect(() => {
        const getStores = async () => {
            const data = await fetch('http://localhost:20004/api/countries_stores')
    ...
    return (
        <>
            <h1>Number of Stores by Country</h1>
...
export default NumberStoresCountry;
