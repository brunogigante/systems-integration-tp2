...
function StoresContacts() {
    ...
    useEffect(() => {
        const getStores = async () => {
            const data = await fetch('http://localhost:20004/api/stores_contacts')
                ...
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center">Store contact</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {
